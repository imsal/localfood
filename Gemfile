...
group :development, :test do
  ...
  # gem "database_cleaner" # added
  gem "rspec-rails", '~> 3.6.0' # added
  gem "factory_girl_rails", "~> 4.8.0" # added
  gem 'capybara', '~> 2.14.0' # added
end
...
# gem 'compass-rails', '~> 2.0.0' # the breakpoint feature
